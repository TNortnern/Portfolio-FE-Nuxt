    ...
    <v-container>
      <v-row justify="center">
        ...
        >
          ...
          >
            <li :data-aos="aosText">
              <span class="d-bloc"><span class="subtitle-2"> - </span> <b>MTA - </b></span>HTML/CSS
            </li>
            <li :data-aos="aosText">
              <span class="d-bloc"><span class="subtitle-2"> - </span> <b>MTA - </b></span> JavaScript
            </li>
            <li :data-aos="aosText">
              <span class="d-bloc"><span class="subtitle-2"> - </span> <b>MTA - </b></span> MySQL
            </li>
          </ul>
        </AboutBrief>
        <AboutBrief
